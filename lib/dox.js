...
// abstracted markdown converter interface
var markdownConverter = {
  toHtml: function(str) {
    return markdown.render(str).trim();
  }
};

// allow custom converters
exports.setMarkdownConverter = function(converter) {
...
exports.parseComment = function(str, options) {
  str = exports.trimIndentation(str).trim(),
  options = options || {};
  ...
  // markdown
  if (!raw) {
    description.full = markdownConverter.toHtml(description.full);
    description.summary = markdownConverter.toHtml(description.summary);
    description.body = markdownConverter.toHtml(description.body);
    comment.tags.forEach(function (tag) {
      if (tag.description) tag.description = markdownConverter.toHtml(tag.description);
      else tag.html = markdownConverter.toHtml(tag.string);
    });
  }
