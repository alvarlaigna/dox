...
exports.parseComment = function(str, options) {
  ...
  // markdown
  if (!raw) {
    description.full = converter.makeHtml(description.full);
    description.summary = converter.makeHtml(description.summary);
    description.body = converter.makeHtml(description.body);
    comment.tags.forEach(function (tag) {
      if (tag.description) tag.description = converter.makeHtml(tag.description);
      else tag.html = converter.makeHtml(tag.string);
    });
  }
